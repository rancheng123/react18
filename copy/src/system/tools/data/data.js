...
/* harmony import */ var util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! util */ "./components/page/util/util.js");
/* harmony import */ var dispatcher__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dispatcher */ "./system/tools/dispatcher.js");
/* harmony import */ var _observer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./observer */ "./system/tools/data/observer.js");
...
function render(component, theme_data) {
  ...
  const promise = util__WEBPACK_IMPORTED_MODULE_0__["Util"].cssParser(component, theme_data, type == 'pc' ? "html" : 'mo'); //获取控件样式节点
  ...
  addComponent(componentData, index, fn, unrender, unuseNewId) {
    ...
    const {
      state: {
        ...
        component: {
          ...
          data = dispatcher__WEBPACK_IMPORTED_MODULE_1__["Dispatcher"].dispatch("getData", {
      value: component
    ...
    if (newData && data) {
      ...
      if (unrender != true) {
        ...
        fn && Object(_observer__WEBPACK_IMPORTED_MODULE_2__["Observer"])('add', component.id, newData.component.id, fn, newData.component);
      }
  ...
  removeComponent(id, fn, unrender) {
    ...
    if (components) {
      ...
      if (index != -1) {
        ...
        fn && Object(_observer__WEBPACK_IMPORTED_MODULE_2__["Observer"])('remove', component.id, recomponent[0].id, fn, index);
...
dispatcher__WEBPACK_IMPORTED_MODULE_1__["Dispatcher"].register("validate", Data.validate, Data);

//# sourceURL=webpack:///./system/tools/data/data.js?