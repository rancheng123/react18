...
export default class HeaderControler extends React.Component {
  constructor(props) {
    super(props); //在线客服不支持先隐藏掉 sxt 2022-11-18
    // {
    //     "href":window.pageData.qq,
    //     "iconClass":"qqkfIcon","iconName":"","target":"_blank",'title':window.public.lang.OnlineService
    // }, 
    ...
    {
      "title": window.pageData.editionname,
      "iconClass": "versionName"
    }, {
      "event": "showHidden",
      "iconName": "showIcon",
    ...
    window.pageData.onlineSite == 0 ? null : {
      ...
      "event": "manage",
      'title': window.public.lang.Administration
