  ...
  drag(opts, event) {
    ...
    if (!opts.component) {
      ...
      if (this.isDragIn(opts.component)) {
        ...
        _system_tools_drag__WEBPACK_IMPORTED_MODULE_1__["Drag"].drag(left, top, {
          width,
          height,
  ...
  async end(opts, event) {
    ...
    try {
      ...
      if (opts.component) {
        ...
        const promise = _system_tools_drag__WEBPACK_IMPORTED_MODULE_1__["Drag"].end(event, opts.component); //如果promise为true，表示新增成功，执行新增成功回调方法
