...
/* harmony import */ var _single_selected__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./single_selected */ "./components/page/attr/select_box/single_selected.js");
/* harmony import */ var _system_tools_single_drag__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../system/tools/single_drag */ "./system/tools/single_drag.js");
/* harmony import */ var _adsorptionv3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./adsorptionv3 */ "./components/page/attr/select_box/adsorptionv3.js");
...
class SelectBox {
  ...
  static selectBox(opts) {
    ...
    if (element) {
      ...
      react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(select.render, {
        select: select,
        dots: opts.dots,
  ...
  render({
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      "data-id": select.id,
      style: state[0]
    }, select.node.current.hidden != '1' ? select.prev() : null, select.node.current.hidden != '1' ? select.selection(dots) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      className: "hidDivBtn",
  ...
  loaded(state, dots) {
    ...
    dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].has(name) && dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].unregister(name); //注册事件

    dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].register(name, setLayout);
  ...
  selection(dots) {
    ...
    }) : null, list ? list.map((e, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      key: i,
      "data-position": e,
      className: `cursor-${e}`
    })) : null);
  ...
  show() {
    ...
    dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].dispatch('selectedHidden', {
      value: true
    });
  }
  /**
  ...
  positionDrag(setLayout, position, event) {
    let {
      ...
      currentX: x,
      currentY: y
    } = _system_tools_single_drag__WEBPACK_IMPORTED_MODULE_4__["default"].move(event); // 获取拖动参数
  ...
  */
  ...
  positionInit() {
    ...
    if (this.node.parent.layout) {
      ...
      if (this.currentEle) {
        ...
        if (this.systype != 'mo') {
          _adsorptionv3__WEBPACK_IMPORTED_MODULE_5__["adsorptionv3"].init(this.currentEle.getBoundingClientRect(), this.node.parent.layout, dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].dispatch("getRuler")); //吸附初始化
        }

        this.addControlPosUnit(id);
        const ediBox = document.querySelector('.ediBox');
        _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].init(ediBox.offsetWidth, ediBox.offsetLeft);
        _system_tools_single_drag__WEBPACK_IMPORTED_MODULE_4__["default"].init(event);
  ...
  positionDragTop({
    ...
    if (this.systype != 'mo') {
      const verSide = _adsorptionv3__WEBPACK_IMPORTED_MODULE_5__["adsorptionv3"].verticalHandle(offsetY, _offsetTop, bottom, height);
    ...
    let dataGet = dispatcher__WEBPACK_IMPORTED_MODULE_2__["Dispatcher"].dispatch(`${id}_get`) || {},
        //获取控件数据
  ...
  positionDragLeft({
    ...
    if (this.systype != 'mo') {
      const horSide = _adsorptionv3__WEBPACK_IMPORTED_MODULE_5__["adsorptionv3"].horizontalHandle(offsetX, _offsetLeft, _right, width);
  ...
  positionDragRight({
    ...
    const selectedWidth = _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].getWidth(),
          _ediBoxWidth = selectedWidth + offsetX; //不走之前的百分比计算了，走老王的算法，不需要判断  sxt 2020-5-23
    //if(scale >= 0 && scale <= 100){


    if (scale < 0) scale = 0;
    _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].setWidth(_ediBoxWidth);
    ...
    const {
      parentNode: {
        offsetWidth: pwidth
          ...
          selectedWidth = _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].getWidth(),
  ...
  positionDragBottomRight({
    ...
    let selectedWidth = _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].getWidth(),
        selectedX = _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].getX(),
        diff = _offsetX * 2,
    ...
    _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].setWidth(_ediBoxWidth);
    _single_selected__WEBPACK_IMPORTED_MODULE_3__["default"].setX(left);
    setLayout({
      left: _offsetLeft,
      top: _offsetTop,
      height,
  ...
  positionEnd(oldLeft, oldTop, event) {
    ...
    if (window.public.type == 'pc') _adsorptionv3__WEBPACK_IMPORTED_MODULE_5__["adsorptionv3"].clearLightColor(); //清除辅助线高亮状态// 调整属性面板的位置
