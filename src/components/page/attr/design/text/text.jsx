...
export default class Text {
  constructor(controler) {
    ...
    this.tabs = this.tabs.bind(this); //unit 绑定this，实现伪继承
  ...
  family() {
    ...
    })) : null, familyShow && familyType == "custom" ? this.familyBox() : null)); // return (<Widget.Select id="font" title="font" list={fonts}
  ...
  */
  ...
  color() {
    ...
    let color = this.state[key]; //mo端没有字体颜色，默认走pc端字体颜色 2021-03-09 by wyq
