...
/* harmony import */ var _public_attribute__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./public_attribute */ "./components/page/attr/public_attribute.js");
...
const Attribute = {
  ...
  publicAttr: _public_attribute__WEBPACK_IMPORTED_MODULE_4__["PublicAttribute"],
  ...
  showAttributePanel(opts) {
    ...
    if (opts.index != -1) {
      ...
      if (element.children.length == 0 || opts.reload || cid != Attribute.currentId) {
        ...
        react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(layer__WEBPACK_IMPORTED_MODULE_2__["Layer"].tab, {
          id: id,
  ...
  async selectBox(opts) {
    const SelectBox = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].selectBox();
  ...
  async basic(opts) {
    ...
    const basic = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].basic(type);
   ...
   */
  async design(opts) {
    const design = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].design();
    design.design(opts);
  },
   ...
   */
  async setting(opts) {
    const setting = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].setting();
  ...
  async animation(opts) {
    const animation = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].animation();
   ...
   */
  async custom(opts) {
    const custom = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].custom();
    custom.custom(opts);
  },
  ...
  */
  async collection(opts) {
    const collection = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].collection();
  ...
  async manage(opts) {
    ...
    const manage = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].manage(type);
    manage.manage(opts);
  },
   ...
   */
  async hiding(opts) {
    const hiding = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].hiding();
    hiding.hiding(opts);
  },
   ...
   */
  async quote(opts) {
    const quote = await attr_manager__WEBPACK_IMPORTED_MODULE_3__["PublicAttrManager"].quote();
    quote.quote(opts);
  }

};

//# sourceURL=webpack:///./components/page/attr/attribute.js?