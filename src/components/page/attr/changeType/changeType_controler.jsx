...
class ChangeTypeControler extends React.Component {
    constructor(props) {
        ...
        this.view = new ChangeType(this); //给view 入口方法绑定this
    ...
    static changeType(opts) {
        ...
        root.render(<ChangeTypeControler id={node.current.id} node={node} />)
    }
    /**
     * @Description: 挂载组件方法
     * @Return: ChangeType
